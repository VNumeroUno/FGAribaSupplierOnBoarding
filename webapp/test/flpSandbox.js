		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Field Glass User Upload",
									"targetURL": "#fguserupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fguserupload-display": {
								"semanticObject": "fguserupload",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fg.userupload",
									"url": sap.ui.require.toUrl("fg/userupload")
								}
							}
						}
					}
